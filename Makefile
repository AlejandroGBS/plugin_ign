...
SOURCES = \
	__init__.py \
	plugin_ign.py plugin_ign_dialog.py

PLUGINNAME = plugin_ign

PY_FILES = \
	__init__.py \
	plugin_ign.py plugin_ign_dialog.py

UI_FILES = plugin_ign_dialog_base.ui
...
QGISDIR=C:\AGB\git-data\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
